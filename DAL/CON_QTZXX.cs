...
namespace DAL
{
	...
	/// 数据访问类:CON_QTZXX
	/// </summary>
	public partial class CON_QTZXX
	{
		public CON_QTZXX()
		{}
		#region  BasicMethod
		...
		public bool Exists(string ID)
		{
			...
			strSql.Append("select count(1) from CON_QTZXX");
		...
		/// 增加一条数据
		/// </summary>
		public bool Add(Model.CON_QTZXX model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into CON_QTZXX(");
			strSql.Append("ID,BH,SJBH,FYR,LXDH,DZYJ,DZ,FYRQ,BLQX,BT,FYNR,NRZY,YQ,FJDZ,FPSJ,JBRQ,JBYQ,LDPS,BZ,CJR,CJSJ,ZT,FJM,XJLY)");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Model.CON_QTZXX model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update CON_QTZXX set ");
			strSql.Append("BH=:BH,");
		...
		public bool Delete(string ID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from CON_QTZXX ");
			strSql.Append(" where ID=:ID ");
			OracleParameter[] parameters = {
					new OracleParameter(":ID", OracleDbType.Varchar2,36)			};
			parameters[0].Value = ID;
		...
		/// 得到一个对象实体
		/// </summary>
		public Model.CON_QTZXX GetModel(string ID)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select ID,BH,SJBH,FYR,LXDH,DZYJ,DZ,FYRQ,BLQX,BT,FYNR,NRZY,YQ,FJDZ,FPSJ,JBRQ,JBYQ,LDPS,BZ,CJR,CJSJ,ZT,FJM,XJLY from CON_QTZXX ");
			strSql.Append(" where ID=:ID ");
			OracleParameter[] parameters = {
					new OracleParameter(":ID", OracleDbType.Varchar2,36)			};
			parameters[0].Value = ID;

			Model.CON_QTZXX model=new Model.CON_QTZXX();
		...
		/// 得到一个对象实体
		/// </summary>
		public Model.CON_QTZXX DataRowToModel(DataRow row)
		{
			Model.CON_QTZXX model=new Model.CON_QTZXX();
			if (row != null)
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select ID,BH,SJBH,FYR,LXDH,DZYJ,DZ,FYRQ,BLQX,BT,FYNR,NRZY,YQ,FJDZ,FPSJ,JBRQ,JBYQ,LDPS,BZ,CJR,CJSJ,ZT,FJM,XJLY ");
			strSql.Append(" FROM CON_QTZXX ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from CON_QTZXX T ");
